...
for i in range (3) :
    ...
    f= open("/Users/noch/Documents/workspace/data_challenge/result/console_pegasos_noDiv.txt","a+")       
    #f= open("/home/jibril/Desktop/data_challenge/result/console_pegasos_noDiv.txt","a+")   
